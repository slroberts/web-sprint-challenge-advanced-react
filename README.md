...
render(){
return(
<>This is an {this.state.example} of a stateful class component</>
)
}
}
...
Mounting - The component gets added into the DOM.
Updating - A component gets updated when there is a change to the component's state or props.
Unmounting - The component gets removed from the DOM.
...
Is logic that is built into a component that uses state.

5. Describe how to test a React component with React Testing Library.

The steps for testing is: arrange, act, assert.
First, we “arrange” our test by setting up our code such that it can be tested.
Second, we “act” - calling a method or function that returns a result of interest to our test.
